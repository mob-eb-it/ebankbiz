...
//                        "</div></div>";
                    var content = "<div id='myModalFullDialog-second' class='modalfulldialogContent'><div id='dialogFullBackground-second'></div><div class='eb-modalfull-content' style='max-width:"+ w +"px; max-height: " + h +"px;'><div class='eb-modalfull-header'><span id ='eb_modalfull_close-second' class='eb-modalfull-close'>&times</span><h4>" + title + "</h4></div>" +
                        "<div class='divider-modal-dialog'></div><div class='eb-modalfull-body'>" + params.contentMessage + "</div>" +
                        "</div></div>";
                    if (parentNote) {
                        var holder = document.createElement('div');
...
//                            "</div></div>";
                        ...
                        var content = "<div id='myModalFullDialog' class='modalfulldialogContent'><div id='dialogFullBackground'></div><div class='eb-modalfull-content' style='max-width:"+ w+"px;max-height:"+ h +"px;'><div class='eb-modalfull-header'><span id ='eb_modalfull_close' class='eb-modalfull-close'>&times</span><h4>" + title + "</h4></div>" +
                            "<div class='divider-modal-dialog'></div><div class='eb-modalfull-body'>" + htmlContent + "</div>" +
                            "</div></div>";
