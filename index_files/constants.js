...
var CONSTANTS = (function() {
    var pConstants = {
        ...
        'CMD_CO_TRANSFER_FAST'                          : '1622', // Chuyển tiền nhanh fast
        ...
        'CMD_AUTH_ACC_OPEN_SAVING_TRANSACTION'          : '1366', //duyet dong mo so
        ...
        'CMD_RIGISTER_CKS'                              : '1220',
        'CMD_RIGISTER_CKS_AUTH'                         : '1271',
        'CMD_SETUP_TOKEN_TYPE'                          : '1204',
        'CMD_AUTH_FPT_PAYMENT'                          : '2011',
        'CMD_MANAGER_FPT_PAYMENT'                       : '2007',
        'CMD_REPORT_TRANS_SUCCESS'                      : '1306',
        'CMD_REPORT_TRANS_ERROR'                        : '1307',
        'CMD_THACO_TEMPALTE'                            : '3001',
        'CMD_THACO_TRANSFER_INTERNAL'                   : '3002',
        'CMD_THACO_AUTH_TRANSFER'                       : '3062',
        'CMD_THACO_QUERY_ACCOUNT'                       : '3004',
        'CMD_THACO_REPORT'                              : '3003',
        'CMD_THACO_LIST_OBJECT'                         : '3005',
        'CMD_THACO_QUERY_TRANSFER'                      : '3006',
        'CMD_QUERY_ELECTRONIC_BILL'                     : '1704',
        // start - 09042019 - taivx.os chinh sua ptxt
        'CMD_GET_AUTHEN_INFOMATION'                     : '4009',
        // end - 09042019 - taivx.os chinh sua ptxt
           // hieuth2
        'CMD_TKTT_TRANSFER'                             : '4010',
        'CMD_TKTT_TRANSFER_DOMESTIC'                    : '4011',
        'CMD_TKTT_AUTHORIZE'                            : '4012',
        'CMD_TKTT_AUTHORIZE_DOMESTIC'                   : '4013',
        'CMD_TKTT_REPORT_INFORMATION'                   : '4015',
        'COM_TKTT_QUERY_TRANSFER'                       : '4014',
         // thue truoc ba
        'CMD_CO_PAY_REGISTRATION_TAX_PROCESSOR'         : '1780',
		//hungtm3 ghtk
        'CMD_MANAGER_GHTK_PAYMENT'                      : '5004',
        'CMD_AUTH_GHTK_PAYMENT'                         : '5005',
		//KHANGTV1.OS - resend mkh ptxt
        'CMD_GET_RESEND_MKH'                            : '4019',
		'CMD_ACCOUNT_OWNER_QUERY'                       : '1311', // Chức năng tra cứu tài khoản đồng sở hữu 
		'CMD_ACCOUNT_FAST_PARTNER_QUERY'                : '1309',
		'CMD_CO_PAY_TAX_SEAPORT'                        : '1781',// phi ha tang cang bien	
    };
...
*/
// var CONST_WEB_SERVICE_LINK = CONST_DEBUG_MODE? "http://localhost:1234/EBCorpServer/ebservice" : "http://localhost:1234/EBCorpServer/ebservice";
// var CONST_WEB_SERVICE_LINK = CONST_DEBUG_MODE? "http://10.1.22.157:8089/EBCorpServer/ebservice" : "http://10.1.22.157:8089/EBCorpServer/ebservice";
// var CONST_WEB_SERVICE_LINK = CONST_DEBUG_MODE? "http://10.1.14.229:9080/EBCorpCore3/ebservice" : "http://10.1.14.229:9080/EBCorpCore3/ebservice";
...
var CONST_KEY_LOAN_PURPOSE_TYPE_VN =['Giải ngân chuyển khoản thanh toán lương','Giải ngân tiền mặt thanh toán lương','Giải ngân chuyển khoản thanh toán ứng trước và/hoặc tạm ứng tiền mua hàng hóa trong nước','Giải ngân chuyển khoản trả sau tiền mua hàng hóa trong nước','Giải ngân cho các đối tượng cung cấp hàng hóa dịch vụ không xuất hóa đơn tài chính','Giải ngân thanh toán trả sau tiền hàng hóa/dịch vụ nhập khẩu','Giải ngân thanh toán trả trước tiền hàng hóa/dịch vụ nhập khẩu','Khác'];
var CONST_KEY_LOAN_PURPOSE_TYPE_EN =['Disbursement for salary payment','Cash disbursement for salary payment','Disbursement of advance payment and/or advance payment for goods purchased in Vietnam','Disbursement of post-paid payment for goods purchased in Vietnam','Disbursement for those who provide goods/services does not issue VAT invoices','Disbursement of postpaid payment for goods/services','Disbursement of prepayment of goods/services','Other'];
...
var CONST_KEY_LOAN_PURPOSE_TYPE_ID =['0','1','2','3','4','5','6','7'];

var CONST_KEY_METHOD_DISBURSERMENT_TYPE_VN = ['Tiền mặt','Chuyển khoản trực tiếp cho bên thụ hưởng','Chuyển khoản vào TKTT của chúng tôi'];
var CONST_KEY_METHOD_DISBURSERMENT_TYPE_EN = ['EN_Tiền mặt','EN_Chuyển khoản trực tiếp cho bên thụ hưởng','EN_Chuyển khoản vào TKTT của chúng tôi'];
var CONST_KEY_METHOD_DISBURSERMENT_TYPE_ID = ['0','1','2'];

var CONST_KEY_METHOD_REPAYMENT_TYPE_VN = ['Tiền mặt','Chuyển khoản','Phương thức khác'];
var CONST_KEY_METHOD_REPAYMENT_TYPE_EN = ['Cash','Transfer','Other method'];
var CONST_KEY_METHOD_REPAYMENT_TYPE_ID = ['TT','CK','OT'];
...
var CONST_VALUE_TRANS_PERIODIC_BN_STT_EN = ['All','Authorised','Partial approved','Pending','Wait for approval of canceling','Approval of canceling partly','Cancelled','Successful cancel', 'Reject'];
...
var CONST_TRANS_TYPE_CONDITION_THACO_VN = ['Chuyển khoản trong TPBank', 'Chuyển khoản liên ngân hàng'];
var CONST_TRANS_TYPE_CONDITION_THACO_EN = ['Internal banking transfer', 'Interbank transaction'];
var CONST_TRANS_TYPE_CONDITION_THACO_ID = ['T22', 'T23'];

var CONST_TRANS_LIST_STATUS_VN = ['Tất cả', 'Đã duyệt', "Đã hủy", 'Duyệt một phần', 'Từ chối', 'Chờ duyệt', 'Duyệt không thành công','Đang chờ xử lý'];
var CONST_TRANS_LIST_STATUS_EN = ['All', 'Authorised', "Cancelled", 'Partial approved', 'Rejected', 'Pending', 'Unsuccessful authorisation','Waiting for progressing'];
var CONST_TRANS_LIST_STATUS = ['ALL', 'ABH', "CAC", 'APT', 'REJ', 'INT', 'RBH','STH'];
...
var CONST_TRANS_BATCH_LIST_STATUS_EN = ["All", "Authorised", "Pending", "Reject", "Partial approved", "Unsuccessful authorisation"];
...
var CONST_APPROVE_TRANS_STATUS_EN = ['All', 'Pending', 'Partial approved'];
...
var CONST_GUARANTEE_STATUS_EN = ['All', 'Pending', 'Partial approved'];
...
var CONST_PAY_TYPE_BILL_VN = ['Thanh toán hóa đơn', 'Thanh toán hóa đơn định kỳ'];
var CONST_PAY_TYPE_BILL_EN =['Bill payment', 'Payment recurring'];
var CONST_PAY_TYPE_BILL_KEY = ['B12', 'B13'];

// khangtv1 them thue cang bien 11/1/2021
var CONST_TRANS_PAY_TAX_TYPE_VALUE_EN = ['Domestic tax','Import/Export tax','Charge and fee tariffs','Charges and fees of ministries','Registration tax','Charges and fees of sea port'];
var CONST_TRANS_PAY_TAX_TYPE_VALUE_VN = ['Thuế nội địa','Thuế xuất nhập khẩu','Phí, lệ phí thuế xuất nhập khẩu','Phí, lệ phí của các bộ, ngành','Thuế trước bạ','Phí hạ tầng cảng biển'];
var CONST_TRANS_PAY_TAX_TYPE_KEY = ['01','02','05','06','03','04'];
...
var CONST_TYPE_APPROVAL_CARD_EN = ['All', 'Pending', 'Partial approved', 'Reject', 'Approved'];
var CONST_TYPE_APPROVAL_CARD_VALUE = ['0', '1', '2', '3', '4'];
// Thanh toán quốc tế -> đề nghị phát hành/tu chỉnh LC -> quản lý giao dịch
var CONST_TYPE_SUGGEST_INTERNATIONAL_VN = ["Tất cả", "Sửa đổi LC ký quỹ 100%", "Đề nghị phát hành LC ký quỹ 100%", "Đề nghị phát hành LC bằng vốn vay, vốn tự có" ];
var CONST_TYPE_SUGGEST_INTERNATIONAL_EN = ["All", "Modify LC by 100% deposit", "Issue LC by 100% deposit", "Issue LC by lending fund"];
//var CONST_TYPE_SUGGEST_INTERNATIONAL_EN = ["All", "Suggest released", "Suggest Correction", "Request for LC"];
var CONST_TYPE_SUGGEST_INTERNATIONAL_VALUE = ['0', '1', '2', '3'];
...
var CONST_TYPE_APPROVAL_INTERNATIONAL_VN = ["Tất cả", "Chờ xử lý" , "Chờ duyệt", "Duyệt một phần", "Từ chối", "Đang xử lý", "Hoàn thành giao dịch", "TPBank từ chối", "Duyệt không thành công", "Ký hoàn thiện chứng từ", "Ký hoàn thiện chứng từ chờ duyệt", "Ký hoàn thiện chứng từ duyệt một phần", "Ký hoàn thiện chứng từ từ chối"];
var CONST_TYPE_APPROVAL_INTERNATIONAL_EN = ["All", "Waiting for progressing" , "Pending", "Partial approved", "Reject", "Processing", "Completed", "Reject by TpBank", "Authorize unsuccessfully", "Finalise documents", "Pending finalization document", "Partial approved finalization document", "Reject finalization document"];
var CONST_TYPE_APPROVAL_INTERNATIONAL_LIST_STATUS = ['ALL', 'STH' ,'INT', 'APT', 'REJ', 'SBP', 'ABH','RSA','RBH','HCP','IHT','APP','RBP'];

//cai dat -> thong tin ca nhan
var CONST_TYPE_SET_INFO_PERSONAL_OTP = ["Hard token","eToken","Chữ ký số"];
var CONST_TYPE_SET_INFO_PERSONAL_OTP_VALUE = ["OTP","VAS","CKS"];
...
var CONST_ACCOUNT_QUERY_TYPE_STATUS_EN = ["All", "Authorised", "Pending", "Partial approved", "Reject", "Unsuccessful authorisation"];
...
var CONST_ACCOUNT_APPROVED_TYPE_STATUS_EN = ["All", "Pending", "Partial approved"];
...
var INTERNAL_TRANS_AUTH_LIST_TRANS_STATUS_EN = ["All", "Pending", "Partial approved"];
...
var UNLOCK_CARD_TRANS_AUTH_STATUS_EN = ["All", "Pending", "Partial approved"];
...
var BATCH_SALARY_MNG_LIST_STATUS_VN = ["Tất cả", "Đã duyệt", "Chờ duyệt", "Từ chối", "Duyệt một phần", "Duyệt không thành công","Chờ duyệt hủy","Duyệt hủy một phần", "Chờ xử lý", "Đã hủy"];
var BATCH_SALARY_MNG_LIST_STATUS_EN = ["All", "Authorised", "Pending", "Reject", "Partial approved", "Unsuccessful authorisation", "Wait for approval of canceling", "Wait for approval of canceling partly", "Waiting for progressing", "Cancelled"];
var BATCH_SALARY_MNG_LIST_STATUS_KEY = ["", "ABH", "INT", "REJ", "APT", "RBH", "PFC", "CPA", "STH", "CAC"];
//END--Quan ly giao dich theo lo

//trangj thai chuyen tien quoc te
var TRANS_MONEY_INTERNATIONAL_STATUSES_VN = ["Tất cả","Chờ duyệt","Duyệt một phần", "Đang xử lý", "Hồ sơ đã được Tiếp nhận", "Duyệt không thành công","Hủy giao dịch",
...
var TRANS_MONEY_INTERNATIONAL_STATUSES_EN = ["All", "Pending", "Partial approved", "Processing", "EN_Hồ sơ đã được Tiếp nhận", "EN_Duyệt không thành công","EN_Hủy giao dịch",
    "Reject", "EN_Hoàn thành giao dịch", "EN_Hoàn chứng từ" , "EN_Chờ duyệt BS CTừ", "EN_Duyệt một phần BS CTừ",
    "EN_Từ chối BS CTừ", "EN_Duyệt BS CTừ  không thành công", "EN_Đang xử lý BS CTừ",  "EN_TPBank từ chối BS CTừ","Reject by TpBank"];
...
var CONST_AUTH_ACC_OPEN_TYPE_STATUS_EN = ["Pending", "Partial approved"];
...
var CONST_AUTH_STATUS_TRANSPDI_EN = ['All', 'Pending', 'Partial approved', 'Wait for approval of canceling', 'Wait for approval of canceling partly'];
...
var CONST_SETUP_QUERY_TRANS_TYPE_DTL_ALL_VN = ["Tất cả", "Cài đặt thông tin cá nhân", "Thay đổi mật khẩu", "Gửi thông báo cho người duyệt", "Phương thức xác thực", "Hạn mức giao dịch", "Đăng ký chữ ký số"];
var CONST_SETUP_QUERY_TRANS_TYPE_DTL_ALL_EN = ["All", "Personal information setting", "Change password", "Send notification to the Authorizer", "Authentication method", "Transaction limit", "Register cerfiticate"];
var CONST_SETUP_QUERY_TRANS_TYPE_DTL_ALL_KEY = ["", "S11", "S12", "S13", "S14", "S15", "S20"];

var CONST_SETUP_QUERY_LIST_STATUS_VN = ["Tất cả", "Đã duyệt", "Chờ duyệt", "Từ chối", "Duyệt một phần", "Duyệt không thành công"];
var CONST_SETUP_QUERY_LIST_STATUS_EN = ["All", "Authorised", "Pending", "Reject", "Partial approved", "Unsuccessful authorisation"];
...
var CONST_MNG_BILL_TYPE_VALUE_VN = ["Tất cả", "Thanh toán hóa đơn","Thanh toán định kỳ"];
var CONST_MNG_BILL_TYPE_VALUE_EN = ["All", "Bill payment","Payment recurring"];
var CONST_MNG_BILL_TYPE_KEY = ['', "B12","B13"];
// Thue truoc ba khangtv1.os 27/03/2020 cap nhat
// khangtv1.os them thue cang bien 11/1/2021
var CONST_MNG_TAX_DETAIL_VALUE_EN = ['All', 'Domestic tax', 'Import/Export tax', 'Phí, lệ phí thuế xuất nhập khẩu','Phí, lệ phí của các bộ, ngành','Registration tax','Charges and fees of sea port'];
var CONST_MNG_TAX_DETAIL_VALUE_VN = ['Tất cả', 'Thuế nội địa', 'Thuế xuất nhập khẩu', 'Phí, lệ phí thuế xuất nhập khẩu','Phí, lệ phí của các bộ, ngành','Thuế trước bạ','Phí hạ tầng cảng biển'];
var CONST_MNG_TAX_DETAIL_KEY = ['', '01', '02', '05', '06','03','04'];

// DiepDN1.OS thêm CAC 
var CONST_MNG_TAX_STATUS_DETAIL_VALUE_VN = ['Tất cả', 'Chờ duyệt', 'Đã duyệt', 'Từ chối', 'Duyệt không thành công', 'Duyệt một phần','Đã hủy', 'Đang chờ xử lý'];
var CONST_MNG_TAX_STATUS_DETAIL_VALUE_EN = ['All', 'Pending', 'Authorised', 'Reject', 'Unsuccessful authorisation', 'Partial approved','Cancelled', 'In process'];
var CONST_MNG_TAX_STATUS_DETAIL_KEY = ['', 'INT', 'ABH', 'REJ', 'RBH', 'APT','CAC', 'STH'];

var CONST_AUTH_TAX_STATUS_DETAIL_VALUE_VN = ['Tất cả', 'Chờ duyệt', 'Duyệt một phần'];
var CONST_AUTH_TAX_STATUS_DETAIL_VALUE_EN = ['All', 'Pending', 'Partial approved'];
...
var CONST_PAYMENT_BILL_TYPE_VN = ["Tất cả", "Thanh toán hóa đơn", "Thanh toán định kỳ"];
var CONST_PAYMENT_BILL_TYPE_EN = ["All", "Pay bills", "Payment recurring"];
var CONST_PAYMENT_BILL_TYPE_KEY = ["", "B12", "B13"];
//Mua ban ngoai te
...
var CONST_FOREIGN_STATUS_EN = ['All', 'Pending', 'Authorised', 'Reject', 'Unsuccessful authorisation', 'Partial approved'];
...
var CONST_GUARANTEE_SUGGEST_TYPE_PURPOSE_EN = ['Additional working capital loan','Import financing loan','Export financing loan','Investment project loan','Loan for buying car','Other'];
...
var CONST_GUARANTEE_TRANS_TYPE_NEW_VN = ['Bảo lãnh thanh toán tiền nộp thuế', 'Bảo lãnh dự thầu', 'Bảo lãnh thực hiện hợp đồng trong trường hợp bên được bảo lãnh và bên nhận bảo lãnh đã ký kết Hợp đồng kinh tế', 'Bảo lãnh thực hiện hợp đồng trong trường hợp bên được bảo lãnh và bên nhận bảo lãnh chưa ký kết Hợp đồng kinh tế', 'Bảo lãnh Bảo hành', 'Bảo lãnh hoàn trả tiền ứng trước (hoàn tạm ứng)', 'Bảo lãnh vay vốn', 'Bảo lãnh thanh toán', 'Bảo lãnh hoàn quyết toán', 'Bảo lãnh đối ứng', 'Khác'];
var CONST_GUARANTEE_TRANS_TYPE_NEW_EN = ['Tax payment guarantee', 'Bid participation guarantee', 'Contract performance guarantee (have economic contract)', "Contract performance guarantee (don't have economic contract)", 'Quality assurance guarantee', 'Advance payment guarantee', 'Loan guarantee', 'payment guarantee', 'Pre-payment return guarantee', 'counter guarantee', 'Other guarantee'];
var CONST_GUARANTEE_TRANS_TYPE_NEW_KEY = ['BL07', 'BL03', 'BL04', 'BL08', 'BL02', 'BL01', 'BL09', 'BL05', 'BL10', 'BL06', 'BL11'];

var CONST_GUARANTEE_QUERY_TYPE_STATUS_VN = ["Tất cả", "Đã duyệt", "Chờ duyệt", "Duyệt một phần", "Từ chối", "Duyệt không thành công"];
var CONST_GUARANTEE_QUERY_TYPE_STATUS_EN = ["All", "Authorised", "Pending", "Partial approved", "Reject", "Unsuccessful authorisation"];
var CONST_GUARANTEE_QUERY_TYPE_STATUS_VALUE = ["", "ABH", "INT", "APT", "REJ", "RBH"];

var CONST_FPT_STATUS_TRANSFER_VN = ["Tất cả", "Chờ duyệt", "Duyệt một phần", "Thành công một phần", "Từ chối", "Đang chờ xử lý", "Thành công", "Thất bại", "Hold"];
var CONST_FPT_STATUS_TRANSFER_EN = ["All", "Pending", "Partial approved", "Partially successful", "Reject", "Processing", "Authorised", "Unsuccessful authorisation", "Hold"];
var CONST_FPT_STATUS_TRANSFER_KEY = ["", "INT", "APT", "ART", "REJ", "STH", "ABH", "RBH", "HOD"];

var CONST_MNG_GUARANTEE_TYPE_VALUE_VN = ['Đề nghị phát hành bảo lãnh'];
var CONST_MNG_GUARANTEE_TYPE_VALUE_EN = ['Request of issuing guarantees'];
var CONST_MNG_GUARANTEE_TYPE_VALUE_KEY = ['01'];
...
var CONST_RELEASE_FORMS_OF_GUARANTEE_EN = ['Issue letter of guarantee in the form of TPBank', 'Issue letter of guarantee not in the form of TPbank'];
...
var CONST_INTERNATIONAL_MONEY_TRANS_EN = ['Payment of imported goods', 'Payment of foreign services'];
...
var CONST_INTERNATIONAL_MONEY_TRANS_TYPE_EN = ['Đề nghị chuyển tiền quốc tế', 'Add documents'];
...
var CONST_INTERNATIONAL_PURPOSE_IMT01_EN = ['Advance payment', 'Payment after recieve'];
...
var CONST_INTERNATIONAL_PURPOSE_IMT02_EN = ['Payment for membership fee at International Organizations or International Conference Registration Fee',
                                            'Payment for work expenses and study expenses of staff members who go on business or study abroad',
                                            'Transfer profit abroad related direct investment activities in Vietnam',
                                            'Payment for salary/bonus/allowance of the foreign employees working in Vietnam',
                                            'Payment for transportation fee',
                                            'Payment for commission and brokerage fees according to export contracts',
                                            'Payment of tourism service fees (domestic company pay for foreign company)',
                                            'Payment for oversea technology transfer/ franchise',
                                            'Payment for establishment and operation expenses of representative offices in foreign countries',
                                            'Payment for copyright registrations, branch maintenance fees',
                                            'Payment of goods transferred from border gate to border gate (according to the regulations of Tpbank each period)',
                                            'Payment for foreign service fees (consultancy fees, technology services..)',
                                            'Payment for online service',
                                            'Transfer direct investment capital and profit out of Vietnam in case of dissolution, termination of operation in Vietnam',
                                            'Transfer profits abroad related to indirect investment activitives in Vietnam',
    ];
...
var CONST_INTERNATIONAL_INTERMEDIARY_BANK_EN = ['Exclude intermediary bank', 'Include intermediary bank'];
...
var CONST_INTERNATIONAL_METHOD_FEE_EN = ['BEN – charge all fees to beneficiary', 'SHA – charge fees in TPbank to sender (transfer fees, swift fee)', 'OUR – charge all fees to sender'];
...
var CONST_INTERNATIONAL_TRANS_STATUS_EN = ["All", "Pending", "Partial approved"];
var CONST_INTERNATIONAL_TRANS_STATUS_KEY = ["", "INT", "APT", "IBS", "APS"];

//trạng thái tra cứu giao dịch chuyển tiền quốc tế
var CONST_INTERNATIONAL_AMOUNT_STATUS_VN = ["Tất cả", "Chờ duyệt", "Duyệt một phần"];
var CONST_INTERNATIONAL_AMOUNT_STATUS_EN = ["All", "Pending", "Partial approved"];
var CONST_INTERNATIONAL_AMOUNT_STATUS_KEY = ["", "INT", "APT" ];

// trạng thái giao dịch LC
var CONST_INTERNATIONAL_TRANS_TYPE_01_STATUS_VN = ["Tất cả", "Chờ duyệt", "Duyệt một phần", "Ký duyệt hoàn thiện chứng từ chờ duyệt", "Ký hoàn thiện chứng từ duyệt 1 phần"];
var CONST_INTERNATIONAL_TRANS_TYPE_01_STATUS_EN = ["All", "Pending", "Partial approved", "Pending finalization document", "Partial approved finalization document"];
var CONST_INTERNATIONAL_TRANS_TYPE_01_STATUS_KEY = ["", "INT", "APT", "IHT", "APP"];
...
var CONST_CKS_REGISTER_VN = ["Đăng ký chữ ký số"];
var CONST_CKS_REGISTER_EN = ["Register Digital Signature"];
var CONST_CKS_REGISTER_VALUE = ["S10"];
...
var CONST_SETUP_CRE_REQUEST_CREATE_EN = ["Additional floating capital loan", "Import financing loan", "Export financing loan", "Investment project loan", "Loan for buying car", "Other"];
...
var CONST_VALUE_TRANS_CRE_REQUEST_CREATE_EN = ['All','Authorised','Partial approved','Pending','Wait for approval of canceling','Approval of canceling partly','Cancelled','Successful cancel', 'Reject'];
var CONST_KEY_TRANS_CRE_REQUEST_CREATE_STT = ['','ABH','APT','INT','PFC','CPA','CAC','RBH', 'REJ'];

var CONST_THACO_TRANS_TYPE_VN = ['Chuyển tiền trong TPBank', 'Chuyển tiền liên ngân hàng'];
var CONST_THACO_TRANS_TYPE_EN = ['Chuyển tiền trong TPBank', 'Chuyển tiền liên ngân hàng'];
var CONST_THACO_TRANS_TYPE_KEY = ['T22', 'T23'];

var CONST_THACO_TRANS_TYPE_SEARCH_VN = ['Tất cả', 'Chuyển tiền trong TPBank', 'Chuyển tiền liên ngân hàng'];
var CONST_THACO_TRANS_TYPE_SEARCH_EN = ['All', 'Chuyển tiền trong TPBank', 'Chuyển tiền liên ngân hàng'];
var CONST_THACO_TRANS_TYPE_SEARCH_KEY = ['', 'T22', 'T23'];

// Bảng trạng thái mới 05/2018 - KienNT13.OS
var CONST_CODE_STATUS_NEW_VN = ['Từ chối','Ký hoàn thiện chứng từ từ chối','Bổ sung chứng từ từ chối','TPBank từ chối',
                                'Chờ xử lý','Đang xử lý','Hoàn thành giao dịch',
                                'Chờ duyệt','Bổ sung chứng từ chờ duyệt',
                                'Ký hoàn thiện chứng từ chờ duyệt',
                                'Duyệt một phần','Ký hoàn thiện chứng từ duyệt một phần','Bổ sung chứng từ duyệt một phần','Duyệt không thành công',
                                'Bổ sung chứng từ','Ký hoàn thiện chứng từ','Hủy giao dịch','Duyệt bổ sung chứng từ không thành công'];
var CONST_CODE_STATUS_NEW_EN = ['Reject','Reject finalization documents','Reject additional documents','Reject by TpBank',
                                'Waiting for progressing','Processing','Completed',
                                'Pending','Pending additional document',
                                'Pending finalization document',
                                'Partial approved','Partial approved finalization document','Partial approved additional document','Authorize unsuccessfully',
                                'Add document','Finalise documents','Reject transaction','Authorize additional documents unsuccessfully'];
var CONST_CODE_STATUS_NEW_KEY = ['REJ','RBP','RES','RSA',
                                 'STH','SBP','ABH',
                                 'INT','IBS',
                                 'IHT',
                                 'APT','APP','APS','RBH',
                                 'REH','HCP','CAC','RBS'];
// endBảng trạng thái mới 05/2018 - KienNT13.OS

// Duyệt đề nghị giải ngân
var CONST_SUGGEST_TRANS_TYPE_VN = ['Đề nghị giải ngân'];//['Đề nghị giải ngân', 'Bổ sung chứng từ', 'Ký hoàn thiện chứng từ'];
var CONST_SUGGEST_TRANS_TYPE_EN = ['Disbursement request'];//['Disbursement request', 'Add documents', 'Finalise documents'];
var CONST_SUGGEST_TRANS_TYPE_ID = ['01'];//['01', '02', '03'];

// Trạng thái mới Duyệt đề nghị giải ngân - bảo lãnh
var CONST_CREDIT_NEW_TRANS_TYPE_VN = ['Tất cả', 'Chờ duyệt','Duyệt một phần','Bổ sung chứng từ chờ duyệt','Bổ sung chứng từ duyệt một phần','Ký hoàn thiện chứng từ chờ duyệt','Ký hoàn thiện chứng từ duyệt một phần'];
var CONST_CREDIT_NEW_TRANS_TYPE_EN = ['All','Pending','Partial approved','Pending additional document','Partial approved additional document','Pending finalization document','Partial approved finalization document'];
var CONST_CREDIT_NEW_TRANS_TYPE_ID = ['','INT','APT','IBS','APS','IHT','APP'];

// Trạng thái mới Quản lý giao dịch giải ngân - bảo lãnh
var CONST_QUERY_NEW_TYPE_STATUS_VN = ['Tất cả', 'Chờ duyệt', 'Duyệt một phần',
    'Bổ sung chứng từ chờ duyệt', 'Bổ sung chứng từ duyệt một phần', 'Ký hoàn thiện chứng từ chờ duyệt',
    'Ký hoàn thiện chứng từ duyệt một phần', 'Chờ xử lý',
    'Đang xử lý', 'Bổ sung chứng từ', 'Ký hoàn thiện chứng từ',
    'Từ chối', 'Bổ sung chứng từ từ chối', 'Ký hoàn thiện chứng từ từ chối','Tpbank Từ chối',
    'Hoàn thành giao dịch'];
var CONST_QUERY_NEW_TYPE_STATUS_EN = ['All', 'Pending', 'Partial approved',
    'Pending additional document', 'Partial approved additional document', 'Pending finalization document',
    'Partial approved finalization document', 'Waiting for progressing',
    'Processing', 'Add document', 'Finalise documents',
    'Reject', 'Reject additional documents', 'Reject finalization documents','Reject by TpBank',
    'Completed'];
var CONST_QUERY_NEW_TYPE_STATUS_ID = ['', "INT", "APT", "IBS", "APS", "IHT", "APP", 'STH', 'SBP', 'REH', 'HCP', 'REJ', 'RES', 'RBP', 'RSA', 'ABH'];


var CONST_LC_TRANS_TYPE_VN = ['Đề nghị phát hành LC bằng vốn vay', 'Đề nghị phát hành LC ký quỹ 100%', 'Sửa đổi LC ký quỹ 100%'];
var CONST_LC_TRANS_TYPE_EN = ['Issue LC by lending fund', 'Issue LC by 100% deposit', 'Modify LC by 100% deposit'];
var CONST_LC_TRANS_TYPE_ID = ['P1', 'P', 'T'];

// Taivx thanh toan hoa don
var CONST_TRANSTYPE_SERVICE_VN = ['Tất cả', 'Cước di động trả sau', 'Cước Internet - ADSL', 'Cước điên thoại cố định', 'Thanh toán TH Cáp trả sau', 'Thanh toán tiền nước', 'Thanh toán tiền điện'];
var CONST_TRANSTYPE_SERVICE_EN = ['All', 'Mobile phone', 'Internet-ADSL', 'Home phone', 'Billing payment of cable postpaid', 'Billing payment of water', 'Electric (EVN)'];
var CONST_TRANSTYPE_SERVICE_ID = ['', '201', '202', '206', '205', '204', '203'];

//ChungNH - thanh toan hoa don
var INTERNAL_TRANS_AUTH_LIST_TRANS_PAYBILL_STATUS_VN = ["Tất cả", "Chờ duyệt", "Duyệt một phần", "Chờ duyệt huỷ", "Duyệt huỷ một phần"];
var INTERNAL_TRANS_AUTH_LIST_TRANS_PAYBILL_STATUS_EN = ["All", "Pending", "Partial approved", "Wait for approval of canceling", "Wait for approval of canceling partly"];
var INTERNAL_TRANS_AUTH_LIST_TRANS_PAYBILL_STATUS_KEY = ["", "INT", "APT", "PFC", "CPA"];

var CONST_TRANS_TYPE_CHILD_VN = ['Chuyển khoản trong TPBank', 'Chuyển khoản liên ngân hàng'];
var CONST_TRANS_TYPE_CHILD_EN = ['Internal banking transfer', 'Interbank transaction'];
var CONST_TRANS_TYPE_CHILD_ID = ['E14', 'E15'];
var CONST_TRANS_TYPE_PARENT_VN = ['Chuyển khoản trong TPBank','Chuyển khoản công ty con','Chuyển khoản liên ngân hàng'];
var CONST_TRANS_TYPE_PARENT_EN = ['Internal banking transfer','Child banking transfer','Interbank transaction'];
var CONST_TRANS_TYPE_PARENT_ID = ['E11','E12','E13'];

var CONST_TRANS_LIST_AMF_STATUS_VN = ['Tất cả', 'Đã duyệt', 'Duyệt một phần', 'Từ chối', 'Chờ duyệt', 'Duyệt không thành công', 'Đang xử lý'];
var CONST_TRANS_LIST_AMF_STATUS_EN = ['All', 'Authorised', 'Partial approved', 'Rejected', 'Pending', 'Unsuccessful authorisation', 'Waiting for progressing'];
var CONST_TRANS_LIST_AMF_STATUS = ['ALL', 'ABH', 'APT', 'REJ', 'INT', 'RBH', 'STH']; 

//HUNGTM3 CHUYEN KHOAN THEO LO B2B 28/05/2020
var CONST_BATCH_B2B_MNG_TRANS_TYPE_VN = ["Tất cả", "Chuyển khoản theo lô trong TPBank", "Chuyển khoản theo lô liên ngân hàng"];
var CONST_BATCH_B2B_MNG_TRANS_TYPE_EN = ["All", "Payroll transfer within TPBank", "Interbank batch transfer"];
var CONST_BATCH_B2B_MNG_TRANS_TYPE_KEY = ["", "B20", "B21"];

var CONST_B2B_STATUS_TRANSFER_VN = ["Tất cả", "Chờ duyệt", "Duyệt một phần", "Thành công một phần", "Từ chối", "Đang chờ xử lý", "Thành công", "Thất bại"];
var CONST_B2B_STATUS_TRANSFER_EN = ["All", "Pending", "Partial approved", "Partially successful", "Reject", "Processing", "Authorised", "Unsuccessful authorisation"];
var CONST_B2B_STATUS_TRANSFER_KEY = ["", "INT", "APT", "ART", "REJ", "STH", "ABH", "RBH"];

var CONST_TICKET_FAST_PARNERT_VN  = ["Phiếu ghi nợ", "Phiếu ghi có"];
var CONST_TICKET_FAST_PARNERT_EN  = ["Debit coupon", "Credit coupon"];
var CONST_TICKET_FAST_PARNERT_KEY = ["D", "C"];
